...
const galleryImages = [
  ...
  { url: `${BASE}13.jpg`, caption: "Senlac Guest House" },
  { url: `${BASE}14.jpg`, caption: "Senlac Exterior" },
  { url: `${BASE}15.jpg`, caption: "Awards & Reviews" },
  { url: `${BASE}19.jpg`, caption: "Local Area" },
  { url: `${BASE}22.jpg`, caption: "Ensuite Bathroom" },
  { url: `${BASE}24.jpg`, caption: "Bedroom" },
  { url: `${BASE}25.jpg`, caption: "Room Amenities" },
  { url: `${BASE}26.jpg`, caption: "Family Room" },
  { url: `${BASE}27.jpg`, caption: "Double Room" },
  { url: `${BASE}28.jpg`, caption: "Bathroom" },
  { url: `${BASE}29.jpg`, caption: "Ensuite Shower" },
  { url: `${BASE}30.jpg`, caption: "Shower" },
